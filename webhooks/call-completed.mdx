...
| `data.midCallTransfer` | boolean             | Whether the AI voice agent transferred the lead during the call. |
| `data.isTransfer`      | boolean             | Whether this is an SMS-initiated transfer call.     |
